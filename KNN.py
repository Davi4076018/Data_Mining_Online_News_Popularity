...
def main():
    ...
    plot_confusion_matrix(cm, ['1', '2', '3', '4', '5'], False, "Confusion Matrix - K-NN")
    plot_confusion_matrix(cm, ['1', '2', '3', '4', '5'], True, "Confusion Matrix - K-NN normalized")
    ...
    # Get test confusion matrix    
    cm = confusion_matrix(y_test, y_hat_test)        
    plot_confusion_matrix(cm, ['1', '2', '3', '4', '5'], False, "Confusion Matrix - K-NN sklearn")
    plot_confusion_matrix(cm, ['1', '2', '3', '4', '5'], True, "Confusion Matrix - K-NN sklearn normalized" )
    plt.show()
